import { Component, EventEmitter, Input, OnInit, Output, OnChanges,
	AfterViewInit, SimpleChanges, QueryList, ViewChildren } from '@angular/core';
...
export class SidebarComponent implements OnInit, OnChanges, AfterViewInit {
  ...
  */
	...
	*/
	private processSectionDataToQueryParams(section: string, data: any) {
		...
		if(data === undefined || data.length <= 0){
			...
			var sectionData = encodeURIComponent(JSON.stringify(data));
	...
	*/
	private addQueryParamsToURL(queryParameters: any = undefined) {
